...
//        _sizes.add(0, new Point((int) (_image.getWidth() / i), (int) (_image.getHeight() / i)));
        ...
        float thumbnailWidth1 = 400;
        scaleRatio = thumbnailWidth1 / _image.getWidth();
        _sizes.add(0, new Point((int) (thumbnailWidth1), (int) (_image.getHeight() * scaleRatio)));

        // Its workaround for default OpenSeadragon viewer, 90px thumbnails
        float thumbnailWidth2 = 90;
        scaleRatio = thumbnailWidth2 / _image.getWidth();
        _sizes.add(0, new Point((int) (thumbnailWidth2), (int) (_image.getHeight() * scaleRatio)));
        // @end refactor this hardcode
    }
